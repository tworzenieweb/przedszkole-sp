...
$settings = array(
    'general' => array(
        ...
        'content' => array(
            'logosource' => array(
                'type' => 'select', 'name' => 'logosource', 'value' => '1', 'ttl' => 'Plik logo',
                'params' => array(
                    '1' => 'Obrazek',
                    '2' => 'Tekst własny'
                ), 'hint' => 'Wybierz plik logo'
            ),
            'logos' => array(
            ...
            'logoimage' => array(
                'type' => 'variant', 'name' => 'logoimage', 'value' => get_template_directory_uri() . '/images/logo.png', 'ttl' => 'Logo image', 'hint' => 'Wprowadź adres URL kierujący do loga'
            ),
            'customtext' => array(
                'type' => 'variant', 'name' => 'customtext', 'value' => get_bloginfo('name'), 'ttl' => 'Własny tekst', 'hint' => 'Wpisz tekst który ma zostać wyświetlony'
            ),
            'sitename' => array(
                'type' => 'text', 'name' => 'sitename', 'value' => '', 'ttl' => 'Front Page Title', 'hint' => 'Nazwa strony'
            ),
            'sitenamereg' => array(
                'type' => 'text', 'name' => 'sitenamereg', 'value' => '%s', 'ttl' => 'Site title', 'hint' => 'Tytuł wewnętrzny'
            ),
            'favicon' => array(
                'type' => 'file', 'name' => 'favicon', 'value' => get_template_directory_uri() . '/images/favicon.png', 'ttl' => 'Favicon', 'hint' => 'Podaj plik ikonki'
            )
        )
    ),
    'slider' => array(
        ...
        'content' => array(
            'txt' => array(
                'type' => 'p', 'name' => '', 'value' => 'Musisz umieścić zdjęcie o wymiarach 990x409px'
            ),
            'source' => array(
                'type' => 'select', 'name' => 'source', 'value' => '1', 'ttl' => 'Źródło/plik',
                'params' => array(
                    '1' => 'Własne slajdy',
                    '2' => 'Slajdy z kategorii',
                    '3' => 'Slajdy z postów',
                    '4' => 'Slajdy ze stron'
                ), 'hint' => 'Wybierz plik który ma zostać dodany'
            ),
            'slides' => array(
            ...
            'showthumbnail' => array(
                'type' => 'check', 'name' => 'showthumbnail', 'value' => '1', 'ttl' => 'Pokaż miniaturę obrazka'
            ),
            'showtext' => array(
                'type' => 'check', 'name' => 'showtext', 'value' => '1', 'ttl' => 'Pokazuj tekst'
            ),
            'showttl' => array(
                'type' => 'check', 'name' => 'showttl', 'value' => '1', 'ttl' => 'Pokazuj tytuł'
            ),
            'showhrefs' => array(
                'type' => 'check', 'name' => 'showhrefs', 'value' => '1', 'ttl' => 'Pokaż linki'
            ),
            'effect' => array(
                'type' => 'select', 'name' => 'effect', 'value' => 'fade', 'ttl' => 'Efekt przejść',
                'params' => array(
                    'blindX' => 'Blind X',
                    'blindY' => 'Blind Y',
                    'blindZ' => 'Blind Z',
                    ...
                    'wipe' => 'Wipe',
                    'zoom' => 'Zoom'
                ), 'hint' => 'Choose anLayout effect for slider'
            ),
            'speed' => array(
                'type' => 'text', 'name' => 'speed', 'value' => '1000', 'ttl' => 'Prędkość (milliseconds)', 'hint' => 'Prędkość przechodzenia slajdów'
            ),
            'timeout' => array(
                'type' => 'text', 'name' => 'timeout', 'value' => '3000', 'ttl' => 'Opóźnienie (milliseconds)', 'hint' => 'Czas przejścia'
            ),
            'pause' => array(
                'type' => 'text', 'name' => 'pause', 'value' => '1000', 'ttl' => 'Pauza (milliseconds)', 'hint' => 'Długość pauzy'
            ),
            'homepage' => array(
                'type' => 'check', 'name' => 'homepage', 'value' => '1', 'ttl' => 'Pokazuj slajdy na stronie głównej'
            ),
            'innerpage' => array(
                'type' => 'check', 'name' => 'innerpage', 'value' => '1', 'ttl' => 'Pokazuj slajdy na innych stronach'
            )
        )
    ),
    'layout' => array(
        ...
        'content' => array(
            'pagelayout' => array(
                'type' => 'sidebars', 'name' => 'pagelayout', 'value' => '2', 'ttl' => 'Układ treści',
                'params' => array(
                    '1' => 'Bez bocznych pasków',
                    '2' => 'Jeden prawy pasek',
                    '3' => 'Jeden lewy pasek',
                    '4' => 'Paski po bokach',
                    '5' => 'Dwa prawe paski',
                    '6' => 'Dwa lewe paski',
                ), 'hint' => 'Możesz ustawić szablon globalny lub dla każdego posta'
            ),
            'dynamiccontent' => array(
                'type' => 'check', 'name' => 'dynamiccontent', 'value' => '1', 'ttl' => 'Wczytuj treść stron dynamicznie', 'hint' => 'Turn on if you want to use dynamic content loader. This options allows to load pages without refresh.'
            ),
            'dpagination' => array(
                'type' => 'check', 'name' => 'dpagination', 'value' => '1', 'ttl' => 'Wczytuj treść postów automatycznie', 'hint' => 'Turn on if you want to use dynamic posts loader. This option allows to load posts when user scrolls page to bottom. It used instead of standard pagination.'
            ),
            'related' => array(
                'type' => 'check', 'name' => 'related', 'value' => '1', 'ttl' => 'Pokazuj powiązane posty?', 'hint' => 'Turn on if you want to show related posts on the post page'
            ),
            'relatedcnt' => array(
                'type' => 'text', 'name' => 'relatedcnt', 'value' => '4', 'ttl' => 'Licznik powiązanych postów'
            ),
            'colors' => array(
                'type' => 'check', 'name' => 'colors', 'value' => '1', 'ttl' => 'Wielokolorowe tło w powiązanych postach'
            ),
            'cuttxton' => array(
                'type' => 'check', 'name' => 'cuttxton', 'value' => '1', 'ttl' => 'Ucinaj tresć w feedach'
            ),
            'cuttxt' => array(
                'type' => 'text', 'name' => 'cuttxt', 'value' => '800', 'ttl' => 'Długość treści w feedach', 'hint' => 'If value more then 0, post in the feed, without excerpt and "read more" tag, will be cutted to that number of chars.'
            ),
            'imgwidth' => array(
                'type' => 'text', 'name' => 'imgwidth', 'value' => '210', 'ttl' => 'Szerokość miniatury w aktualnościach - szerokość', 'hint' => 'Featured images width (px)'
            )
            ,
            'imgheight' => array(
                'type' => 'text', 'name' => 'imgheight', 'value' => '126', 'ttl' => 'Szerokość miniatury w aktualnościach - wysokość', 'hint' => 'Featured images height (px)'
            ),
            'imgpos' => array(
                'type' => 'select', 'name' => 'imgpos', 'value' => 'alignleft', 'ttl' => 'Pozycja obrazka',
                'params' => array(
                    'alignleft' => 'Lewo',
                    'alignright' => 'Prawo',
                    'aligncenter' => 'Środek'
            ...
            'footerwidgets' => array(
                'type' => 'check', 'name' => 'footerwidgets', 'value' => '1', 'ttl' => 'Pokazuj widgety w stopce?'
            ),
            'footertext' => array(
                'type' => 'textarea', 'name' => 'footertext', 'value' => '', 'ttl' => 'Własny tekst w stopce'
            ),
        )
    ),
//    'social' => array(
...
//    ),
    'contactform' => array(
        ...
        'content' => array(
            'txt' => array(
                'type' => 'p', 'name' => '', 'value' => 'Aby dodać formularz musisz ustawić szablon strony na Contact'
            ),
            'text' => array(
                'type' => 'textarea', 'name' => 'text', 'value' => 'Find and contact us', 'ttl' => 'Tekst', 'hint' => 'Enter text for contact page.'
            ),
            'address' => array(
                'type' => 'text', 'name' => 'address', 'value' => 'Baker St 221b, London', 'ttl' => 'Adres na mapie', 'hint' => 'Enter address or longitude and latitude for map center. For example "Baker St 221b, London" and "51.523795,-0.158465" have the same result.'
            ),
            'details' => array('type' => 'details', 'ttl' => 'Dane kontaktowe', 'value' => array(
                    '1' => Array(
            ...
            'contactform' => array('type' => 'contactform', 'ttl' => 'Formularz', 'value' => array(
                    '1' => Array(
                        'ttl' => 'Your name',
                        'req' => 'required',
                        'type' => 'text'
            ...
            'email' => array(
                'type' => 'text', 'name' => 'email', 'value' => 'mail@yourdomain.com', 'ttl' => 'Gdzie wysyłać wiadomości', 'hint' => 'The contact form will be submited this email. Do not leave this field empty to display contact form'
            )
        )
    ),
//		'contacts'=>array(
