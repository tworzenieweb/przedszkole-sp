    ...
    $settings = array(
		...
		'slider'=>array(
			...
			'content'=>array(
				...
				'speed'=>array(
					'type'=>'text','name'=>'speed','value'=>'1000','ttl'=>'Speed (milliseconds)', 'hint'=>'Prędkość przechodzenia slajdów'
				),
				'timeout'=>array(
					'type'=>'text','name'=>'timeout','value'=>'3000','ttl'=>'Timeout (milliseconds)','hint'=>'Czas przejścia'
				),
				'pause'=>array(
					'type'=>'text','name'=>'pause','value'=>'1000','ttl'=>'Pause (milliseconds)','hint'=>'Długość pauzy'
				),
				'homepage'=>array(
